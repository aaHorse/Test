...
import main.project_2.client.System_v_client;
 ...
 */
public class System_m_client_2 {
    ...
    private User user;
    private System_v_client_2.View view;


    public boolean connectServer(User user, System_v_client_2.View view) {
        try {
            this.user=user;
            this.view=view;
